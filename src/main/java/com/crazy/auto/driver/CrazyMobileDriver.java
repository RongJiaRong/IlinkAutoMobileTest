	...
	public AppiumDriver getDriver(String platform, String udid,String port,String chromedriverpath) {
		try {
			if (MobilePlatform.ANDROID.equalsIgnoreCase(platform)) {
				...
				log.error("platform is error, platform must be android or ios");
				throw new PlatformException("platform is error, platform must be android or ios");
			}
		} catch (Exception e) {
...
//			caps.setCapability("appActivity","com.lanyou.base.ilink.activity.login.SplashActivity");
			return caps;
